...
// Compact college data: [name, shortName, city, state, type, estYear, students, naac, fees, placePct, avgPkg, highPkg, rating, reviewCount, recruiters, courses, cutoffs]
const colleges: any[][] = [
// IITs (8)
...
async function main() {
  console.log('Seeding database with 60 colleges...');
